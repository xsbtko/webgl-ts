...
declare module 'twgl.js' {
  ...
  export function createTransformFeedback(
    ...
    bufferInfo?: BufferInfo | {[key: string]: AttribInfo}
  ): WebGLObject
  ...
  export namespace primitives {
    ...
    export function createCresentBufferInfo(
      gl: WebGLRenderingContext,
    ...
    export function createCresentBuffers(
      gl: WebGLRenderingContext,
      verticalRadius: number,
      outerRadius: number,
      innerRadius: number,
    ...
    export function createCresentVertices(
      verticalRadius: number,
      outerRadius: number,
      innerRadius: number,
      thickness: number,
    ...
    export function createCylinderBufferInfo(
      gl: WebGLRenderingContext,
      radius: number,
      height: number,
      ...
      topCap?: boolean,
      bottomCap?: boolean
    ): {[key: string]: BufferInfo}
    export function createCylinderBuffers(
      gl: WebGLRenderingContext,
      radius: number,
      height: number,
      radialSubdivisions: number,
    ...
    export function createDiscBufferInfo(
      gl: WebGLRenderingContext,
      radius: number,
      divisions: number,
      stacks?: number,
    ...
    export function createDiscBuffers(
      gl: WebGLRenderingContext,
      radius: number,
      divisions: number,
      stacks?: number,
    ...
    export function createPlaneBufferInfo(
      gl: WebGLRenderingContext,
      width?: number,
      depth?: number,
    ...
    export function createPlaneBuffers(
      gl: WebGLRenderingContext,
      width?: number,
      depth?: number,
      subdivisionsWidth?: number,
    ...
    export function createSphereBuffers(
      ...
      opt_startLongitudeInRadians?: number,
      opt_endLongitudeInRadians?: number
    ): {[key: string]: WebGLBuffer; numElements: number}
    ...
    export function createTorusBufferInfo(
      gl: WebGLRenderingContext,
      radius: number,
      thickness: number,
      radialSubdivisions: number,
    ...
    export function createTruncatedConeBufferInfo(
      ...
      radialSubdivisions: number,
      verticalSubdivisions: number,
      opt_topCapopt?: boolean,
      opt_bottomCap?: boolean
    ): BufferInfo
    export function createTruncatedConeBuffers(
      gl: WebGLRenderingContext,
      bottomRadius: number,
      topRadius: number,
      height: number,
  ...
  export function createAttributeSetters(gl: WebGL2RenderingContext, program: WebGLProgram): {[key: string]: (attr: any) => void}
  ...
  export function createUniformSetters(gl: WebGL2RenderingContext, program: WebGLProgram): {[key: string]: (attr: any) => void}

  /** @deprecated */
  export function setAttributes(setters: {[key: string]: (attr: any) => void}, buffers: {[key: string]: AttribInfo}): void
  ...
  export function setBuffersAndAttributes(
    gl: WebGLRenderingContext,
    setters: ProgramInfo | {[key: string]: (...params: any[]) => void},
    buffers: BufferInfo | VertexArrayInfo
  ): void
  ...
  export function createTextures(
    gl: WebGLRenderingContext,
    options?: {[key: string]: TextureOptions},
  ...
  export function loadCubemapFromUrls(gl: WebGLRenderingContext, tex: WebGLTexture, options: TextureOptions, callback?: TextureReadyCallback): void
  export function loadSlicesFromUrls(gl: WebGLRenderingContext, tex: WebGLTexture, options: TextureOptions, callback?: TextureReadyCallback): void
  ...
  export function setDefaultTextureColor(color: [number, number, number, number]): void
  ...
  export function setTextureFilteringForSize(
    gl: WebGLRenderingContext,
    tex: WebGLTexture,
  ...
  // vertexArrays module
  export function createVAOAndSetAttributes(
    gl: WebGLRenderingContext,
    setters: {[key: string]: (value: any) => void},
    attribs: {[key: string]: AttribInfo},
    indices?: WebGLBuffer
  ): WebGLVertexArrayObject
  export function createVAOFromBufferInfo(
    gl: WebGLRenderingContext,
    programInfo: {[key: string]: (value: any) => void} | ProgramInfo,
    bufferInfo: BufferInfo,
    indices?: WebGLBuffer
  ): WebGLVertexArrayObject
  export function createVertexArrayInfo(
    gl: WebGLRenderingContext,
    programInfo: ProgramInfo | Array<ProgramInfo>,
    bufferInfo: BufferInfo
  ): WebGLVertexArrayObject
}
